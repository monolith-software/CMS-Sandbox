...
//        $cache->set('tobias', 'value_tobias2222', ['tag2', 'tag1']);
//        $cache->set('aaron', 'value_aaron222222', ['tag0']);

//        $pool->invalidateTags(['tag0']);
//        ld($pool);

//        $pool->getItem('tobias')->isHit(); // false
//        $pool->getItem('aaron')->isHit(); // true

//        dump($pool->getItem('tobias')->get());
//        dump($pool->getItem('aaron')->get());

        dump($cache->getItem('tobias'));
        dump($cache->getItem('aaron'));
